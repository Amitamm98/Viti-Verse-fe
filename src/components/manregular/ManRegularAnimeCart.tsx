...
import {
  ...
  default as image11,
  default as image12,
} from "../../assets/oversized content/anime oversized/an11.webp";
import {
  default as image13,
  default as image14,
  default as image15,
} from "../../assets/oversized content/anime oversized/an18.jpg";
import {
  default as image16,
  default as image17,
  default as image18,
} from "../../assets/oversized content/anime oversized/an19.jpg";
import {
  default as image1,
  default as image2,
  default as image3,
} from "../../assets/oversized content/anime oversized/an2.jpg";
import {
  default as image19,
  default as image20,
  default as image21,
} from "../../assets/oversized content/anime oversized/an20.webp";
import {
  default as image4,
  default as image5,
  default as image6,
} from "../../assets/oversized content/anime oversized/an6.webp";
import {
  default as image7,
  default as image8,
  default as image9,
} from "../../assets/oversized content/anime oversized/an7.webp";
...
const ManRegularAnimeCart = () => {
  return (
    <section className="w-full h-full px-4 bg-white -mt-[0px] ">
      <h2 className="text-6xl font-semibold text-center py-20 mb-12">
        Anime Regular Collection
      </h2>
...
export default ManRegularAnimeCart;
