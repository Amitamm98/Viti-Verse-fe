...
import image11 from "../../assets/images/img11.webp";
...
const ManFeaturedCollection: React.FC = () => {
  return (
    <section className="w-full h-full px-4 bg-white -mt-[0px]">
      <h2 className="text-5xl font-semibold text-center py-18 mb-12">Featured Collection</h2>
...
export default ManFeaturedCollection;
